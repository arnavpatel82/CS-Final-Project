...
class ChatbotGUI(ttk.Frame):
    ...
    def create_widgets(self):
        self.chat_history = Text(self, state=DISABLED)
        self.chat_history.pack(side=TOP, fill=BOTH, expand=YES)

        self.chat_input = Entry(self)
        self.chat_input.pack(side=LEFT, fill=X, expand=YES)
